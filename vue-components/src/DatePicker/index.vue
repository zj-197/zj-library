...
import { getDateByDate, shortcutsOfDateAfter, shortcutsOfDateBefore, shortcutsOfDateRangeAfter, shortcutsOfDateRangeBefore } from './utils'
defineOptions({
    name: 'DatePicker'
})
...
<template>
    <component :is="h(ElDatePicker, { ...$attrs, ...props, placeholder, startPlaceholder, endPlaceholder, shortcuts, disabledDate, ref: changeRef }, $slots)"></component>
</template>
